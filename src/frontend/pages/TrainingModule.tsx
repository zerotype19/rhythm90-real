      ...
      content: (
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-red-50 to-orange-50 p-6 rounded-lg border border-red-200">
            ...
            <p className="text-gray-700 mb-4">
              This Rhythm90 guide will guide you through the core concepts and tools that make Rhythm90 work. 
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-orange-50 to-red-50 p-6 rounded-lg border border-orange-200">
            <h4 className="font-semibold text-orange-900 mb-3">Quarterly Planner</h4>
            <p className="text-orange-800 mb-4">
              Full 90-day schedule with role-specific views and activities.
            </p>
            <p className="text-orange-700 text-sm mb-4">
  ...
  return (
    <AppLayout>
      <div className="p-6">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Rhythm90 Guide</h1>
