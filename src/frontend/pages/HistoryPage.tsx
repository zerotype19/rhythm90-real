...
const HistoryPage: React.FC = () => {
  ...
  const openShareModal = (response: SavedResponse) => {
    ...
    if (response.is_shared_public) {
      setShareType('public');
    } else if (response.is_shared_team) {
      setShareType('team');
    } else {
      setShareType(null);
    }
          ...
          <div className="bg-white rounded-lg max-w-md w-full">
            ...
            <div className="p-6">
                ...
                <div className="space-y-2">
                  ...
                  <label className="flex items-center">
                    <input
                      ...
                      name="shareType"
                      value="none"
                      checked={shareType === null}
                      onChange={(e) => setShareType(null)}
                      className="mr-2"
                    />
                    <span className="text-sm">Unshare (remove all sharing)</span>
                  </label>
                </div>
              </div>
              ...
              <div className="flex justify-end gap-3">
                ...
                >
                  {sharing ? 'Updating...' : (shareType === null ? 'Unshare' : 'Update Sharing')}
                </button>
              </div>
            </div>
          </div>
