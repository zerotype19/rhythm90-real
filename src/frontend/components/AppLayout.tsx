...
function AppLayout({ children }: AppLayoutProps) {
  ...
  const workingTools = [
    ...
    { name: 'Quarterly Planner', href: '/app/tools/planner', icon: 'M8 7V3a1 1 0 011-1h6a1 1 0 011 1v4m-8 0h8m-8 0a2 2 0 00-2 2v8a2 2 0 002 2h8a2 2 0 002-2V9a2 2 0 00-2-2m-8 0v4h8V9a2 2 0 00-2-2' },
