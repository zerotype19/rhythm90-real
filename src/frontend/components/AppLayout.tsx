...
function AppLayout({ children }: AppLayoutProps) {
  ...
  const navigation = [
    ...
    { name: 'Mini Tools', href: '/app/mini-tools', icon: 'M19.428 15.428a2 1 2 0 00-2.828 0L10 20.172l-6.586-6.586a2 1 2 0 00-2.828 2.828l8 8a2 1 2 0 002.828 0l8-8a2 1 2 0 000-2.828z' },
